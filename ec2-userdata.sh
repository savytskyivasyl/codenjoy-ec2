...
mvn clean install -N -DskipTests=true
cd ../../server
nohup mvn clean spring-boot:run -DMAVEN_OPTS=-Xmx1024m -Dmaven.test.skip=true -Dspring.profiles.active=sqlite,bomberman,debug -Dcontext=/codenjoy-contest -Dserver.port=8080 -Pbomberman &
